...
<php lang="en">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-phone-volume"></i>phone</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-radiation"></i>radiation</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-angle-down"></i>angle-down</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-angle-left"></i>angle-left</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-angle-right"></i>angle-right</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-angle-up"></i>angle-up</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-caret-left"></i>caret-left</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-caret-right"></i>caret-right</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-download"></i>download</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-backward"></i>backward</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-volume-down"></i>volume-down</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-volume-mute"></i>volume-mute</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-volume-off"></i>volume-off</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="las la-volume-up"></i>volume-up</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <a class="iq-icons-list" href="#"><i
                                                    class="lab la-pinterest-p"></i>pinterest</a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
    ...
    <!-- Mirrored from iqonic.design/themes/DealNice/php/icon-lineawesome.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:53 GMT -->
