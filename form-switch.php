...
<php lang="en">
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <div class="custom-control custom-switch custom-control-inline">
                                        ...
                                        <label class="custom-control-label" for="customSwitch4">disable /
                                            Inactive</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <div
                                        ...
                                        <div class="custom-switch-inner">
                                            ...
                                            <label class="custom-control-label" for="customSwitch-33"
                        ...
                        <div class="col-sm-12 col-lg-12">
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <div class="custom-control custom-switch custom-switch-color custom-control-inline">
                                        <input type="checkbox" class="custom-control-input bg-waring"
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <div
                                        ...
                                        <div class="custom-switch-inner">
                                            <p class="mb-0"> Info </p>
                                            <input type="checkbox" class="custom-control-input bg-info"
                                                id="customSwitch-6" checked="">
    ...
    <!-- Mirrored from iqonic.design/themes/DealNice/php/form-switch.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:47 GMT -->
