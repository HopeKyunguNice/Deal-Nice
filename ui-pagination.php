...
<php lang="en">
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <p>While the <code>.disabled</code> class uses <code>pointer-events: none</code> to
                                        <em>try</em> to disable the link functionality of <code>&lt;a&gt;</code>s, that
                                        CSS
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>Change the alignment of pagination components with <a
                                            href="https://iqonic.design/docs/4.3/utilities/flex/">flexbox utilities</a>.
                                    </p>
                                    <h6>left</h6>
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
    ...
    <!-- Mirrored from iqonic.design/themes/DealNice/php/ui-pagination.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:47 GMT -->
