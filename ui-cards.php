...
<php lang="en">
            ...
            <div id="content-page" class="content-page">
                <div class="container-fluid">
                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height iq-mb-3">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <p class="card-text">It is a long established fact that a reader will be distracted
                                        by
                                        the readable content of a page when looking at its layout. </p>
                                    <p>It is a long established fact that a the readable content of a page when looking
                                        at
                                        its layout.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div
                                class="iq-card iq-card-block iq-card-stretch iq-card-height bg-dark text-white iq-mb-3">
                            ...
                            <div class="iq-card text-white bg-primary iq-mb-3">
                                <div class="iq-card-body">
                                    ...
                                    <blockquote class="blockquote mb-0">
                                        ...
                                        <footer class="blockquote-footer text-white font-size-12">Someone famous in
                                            <cite title="Source Title" class="text-white">Source Title</cite>
                                        </footer>
                                    </blockquote>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card iq-mb-3 border-primary">
                                <div class="card-body text-primary">
                                    ...
                                    <p class="card-text">Some quick example text to build on the card title text to
                                        build on
    ...
    <!-- Mirrored from iqonic.design/themes/DealNice/php/ui-cards.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:27 GMT -->
