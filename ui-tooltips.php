                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>Hover over the buttons below to see the four tooltips directions: top, right,
                                        bottom,
                                    ...
                                    <button type="button" class="btn btn-secondary rmt-5" data-toggle="tooltip"
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <button type="button" class="btn btn-info rmt-5" data-toggle="tooltip"
                                        data-placement="left" title="Tooltip on left">
                                        Tooltip on left
                                    </button>
                                </div>
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <button type="button" class="btn iq-bg-primary" data-toggle="tooltip"
                                        data-placement="top" title="Tooltip on top">
                                        Tooltip on top
                                    </button>
                                    <button type="button" class="btn iq-bg-success" data-toggle="tooltip"
                                        data-placement="right" title="Tooltip on right">
                                        Tooltip on right
                                    </button>
                                    <button type="button" class="btn iq-bg-danger" data-toggle="tooltip"
                                        data-placement="bottom" title="Tooltip on bottom">
                                        Tooltip on bottom
                                    </button>
                                    <button type="button" class="btn iq-bg-info rmt-5" data-toggle="tooltip"
                                        data-placement="left" title="Tooltip on left">
                                        Tooltip on left
                                    </button>
                                </div>
