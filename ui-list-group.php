...
<php lang="en">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>Add <code>.disabled</code> to a <code>.list-group-item</code> to make it
                                        ...
                                        will
                                        also require custom JavaScript to fully disable their click events (e.g.,
                                        links).
                                    </p>
                                    <ul class="list-group">
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>Add <code class="highlighter-rouge">.list-group-flush</code> to remove some
                                        borders
                                        and rounded corners to render list group items edge-to-edge in a parent
                                        container
                                        (e.g., cards).</p>
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>Add badges to any list group item to show unread counts, activity, and more with
                                        the
                                        help of some <a
                                            href="https://iqonic.design/docs/4.3/utilities/flex/">utilities</a>.
                                    </p>
                                    <ul class="list-group">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>Add <code>.active</code> to a <code>.list-group-item</code> to indicate the
                                        current
                                        active selection.</p>
                                    <ul class="list-group">
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>Add <code>.list-group-horizontal</code> to change the layout of list group items
                                        from
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>Add nearly any php within, even for linked list groups like the one below, with
                                        the
                                        help of <a href="https://iqonic.design/docs/4.3/utilities/flex/">flexbox
                                            utilities</a>.</p>
                                    <div class="list-group">
                                        <a href="#" class="list-group-item list-group-item-action active">
    ...
    <!-- Mirrored from iqonic.design/themes/DealNice/php/ui-list-group.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:46 GMT -->
