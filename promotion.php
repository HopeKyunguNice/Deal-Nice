                        ...
                        <div class="col-lg-12">
                            <div class="iq-card-transparent mb-0">
                                <div class="d-block text-center">
                                    <h2 class="mb-3">Produits en promotion cette semaine</h2>
                                </div>
                            </div>
                            <div class="iq-card">
                                <div class="iq-card-body">
                                    <div class="row">
                                        ...
                                        $statement->execute(array('%promotion%',));
                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                ...
                                <div class="iq-card-body similar-contens">
                                    <ul id="similar-slider" class="list-inline p-0 mb-0 row">
                                        ...
                                        $statement = $pdo->prepare($sql);
                                        $statement->execute(array('%Electroni%',));
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                                        <li class="col-md-3">
                                            <?php
                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                ...
                                <div class="iq-card-body trendy-contens">
                                    <ul id="trendy-slider" class="list-inline p-0 mb-0 row">
                                        ...
                                        $statement = $pdo->prepare($sql);
                                        $statement->execute(array('%Promotion Chaussure%',));
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                                        <li class="col-md-3">
                                            <?php
                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                ...
                                <div class="iq-card-body favorites-contens">
                                    <ul id="favorites-slider" class="list-inline p-0 mb-0 row">
                                        ...
                                        $sql = "SELECT * FROM tbl_product WHERE ecat_id IN ( SELECT ecat_id FROM tbl_end_category INNER JOIN tbl_mid_category ON tbl_mid_category.mcat_id = tbl_end_category.mcat_id AND tbl_mid_category.mcat_name LIKE ? ) LIMIT 6";
                                        $statement = $pdo->prepare($sql);
                                        $statement->execute(array('%Promotion vetement%',));
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                                        <li class="col-md-3">
                                            <?php
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="col-7">
                                                    ...
                                                    <p class="mb-2"><?php echo $value['ecat_name']; ?></p>
                                                    <div
                                                    ...
                                                    <a href="product.php?id=<?php echo $row['p_id']; ?>"
                                                        class="text-dark">Voir<i class="ri-arrow-right-s-line"></i></a>
                                                </div>
                                            </div>
                                        </li>
                                        <?php
