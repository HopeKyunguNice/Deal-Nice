...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		if($path == '') {
			...
			unlink('../assets/images/slider/'.$_POST['current_photo']);

			$final_name = 'slider-'.$_REQUEST['id'].'.'.$ext;
        	move_uploaded_file( $path_tmp, '../assets/images/slider/'.$final_name );
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="padding-top:5px">
                                <video playsinline autoplay muted loop
                                    poster="../assets/images/slider/<?php echo $row['photo']; ?>" style="width:400px;">
                                    <source src="../assets/images/slider/<?php echo $row['photo']; ?>" type="video/webm"
