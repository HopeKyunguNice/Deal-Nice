...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	if( isset($_FILES['photo']["name"]) && isset($_FILES['photo']["tmp_name"]) )
        {
            ...
            for($i=0;$i<count($photo);$i++)
            {
		        ...
		        if( $my_ext1=='jpg' || $my_ext1=='png' || $my_ext1=='jpeg' || $my_ext1=='gif' ) {
                    ...
                    move_uploaded_file($photo_temp[$i],"../assets/images/partenaire/photo/".$final_name1[$m]);
                    $m++;
                    $z++;
		        }
            }
        ...
        if($path == '') {
        	...
        	move_uploaded_file( $path_tmp, '../assets/images/partenaire/'.$final_name );
    	...
    	$success_message = 'Partenaires mise à jour avec succès';
    }
}
?>
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Non de l'entreprise<span>*</span></label>
                            <div class="col-sm-4">
                                <input type="text" name="p_name" class="form-control" value="<?php echo $p_name; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Logo Existant</label>
                            <div class="col-sm-4" style="padding-top:4px;">
                                <img src="../assets/images/partenaire/<?php echo $p_featured_photo; ?>" alt=""
                                    style="width:150px;">
                                <input type="hidden" name="current_photo" value="<?php echo $p_featured_photo; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Changer le Logo</label>
                            <div class="col-sm-4" style="padding-top:4px;">
                            ...
                            <div class="col-sm-4" style="padding-top:4px;">
                                <table id="ProductTable" style="width:100%;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="../assets/images/partenaire/photo/<?php echo $row['photo']; ?>"
