                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td style="width:150px;"> <video playsinline autoplay muted loop
                                        poster="../assets/images/slider/<?php echo $row['photo']; ?>"
                                        style="width:400px;">
                                        <source src="../assets/images/slider/<?php echo $row['photo']; ?>"
                                            type="video/webm" style="width:400px; alt=" <?php echo $row['heading']; ?>">
                                    </video>"
                                </td>
