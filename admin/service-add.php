    ...
    if($valid == 1) {
    	...
    	if( isset($_FILES['photo']["name"]) && isset($_FILES['photo']["tmp_name"]) )
        {
            ...
            for($i=0;$i<count($photo);$i++)
            {
		        ...
		        if( $my_ext1=='jpg' || $my_ext1=='PNG' || $my_ext1=='JPG' || $my_ext1=='gif' ) {
    	...
    	$success_message = 'Partenaire ajouter avec succès.';
    }
}
?>
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Nom de l'entreprise<span>*</span></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Logo <span>*</span></label>
