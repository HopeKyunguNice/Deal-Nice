...
<head>
    ...
    <title>DealNice Admin Panel</title>
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="index.php" class="logo">
                <span class="logo-lg">DealNice</span>
            </a>
            <nav class="navbar navbar-static-top">
                <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
                    <span class="sr-only">Toggle navigation</span>
                </a>
                <span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Panneau
                    D'administrateur</span>
            ...
            <section class="sidebar">
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'settings.php') ) {echo 'active';} ?>">
                        <a href="settings.php">
                            <i class="fa fa-sliders"></i> <span>Réglage du Web</span>
                        </a>
                    </li>
                    ...
                    <li
                        ...
                        <a href="#">
                            ...
                            <span>Réglage de la boutique</span>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="country.php"><i class="fa fa-circle-o"></i> Ville</a></li>
                    ...
                    <li
                        ...
                        <a href="product.php">
                            <i class="fa fa-shopping-bag"></i> <span>Gestion Produits</span>
                        </a>
                    </li>
                    ...
                    <li
                        ...
                        <a href="customer.php">
                            <i class="fa fa-user-plus"></i> <span>Clients enregistés</span>
                        </a>
                    </li>

                    <li class="treeview <?php if( ($cur_page == 'page.php') ) {echo 'active';} ?>">
                        <a href="page.php">
                            <i class="fa fa-tasks"></i> <span>Réglage des pages</span>
                        </a>
                    </li>
