...
<php lang="en">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <div class="checkbox d-inline-block mr-2">
                                        <input type="checkbox" class="checkbox-input" id="checkbox4" checked=""
                                            disabled="">
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        ...
                                        <label class="custom-control-label" for="customCheck5">Primary /
                                            Inactive</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
    ...
    <!-- Mirrored from iqonic.design/themes/DealNice/php/form-chechbox.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:47 GMT -->
