                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
                                        ...
                                        <option value="Bank Deposit">Cash</option>
                                    </select>
                                </div>
                                ...
                                <form class="paypal" action="<?php echo BASE_URL; ?>payment/paypal/payment_process.php"
                                    ...
                                    <div class="col-md-12 form-group">
                                        <input type="submit" class="btn btn-primary"
                                            value="<?php echo LANG_VALUE_46; ?>" name="form1">
                                    </div>
                                </form>
                                ...
                                <form action="payment/bank/init.php" method="post" id="bank_form">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label for=""> Détails sur la paiement </span></label><br>
                                        <?php
                                            $statement = $pdo->prepare("SELECT * FROM tbl_settings WHERE id=1");
                                            $statement->execute();
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                    ...
                                    <!-- <?php echo LANG_VALUE_44; ?> -->
                                    <div class="col-md-12 form-group">
                                        <label for="">Veillez saisir le code juste en bas pour confirmer
                                            l'achat<br><span
                                    ...
                                    <div class="col-md-12 form-group">
                                        <input type="submit" class="btn btn-primary"
                                            value="<?php echo LANG_VALUE_46; ?>" name="form3">
                                    </div>
                                </form>
