                        ...
                        <div class="col-lg-12">
                            <div class="iq-card-transparent mb-0">
                                <div class="d-block text-center">
                                    <h2 class="mb-3">Bijoux & Montre </h2>
                                </div>
                            </div>
                            <div class="iq-card">
                                <div class="iq-card-body">
                                    <div class="row">
                                        ...
                                        $statement->execute(array('%Bijoux Montre%',));
                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                <div
                                    ...
                                    <div class="iq-header-title">
                                        <h4 class="card-title mb-0">Accessoires</h4>
                                    </div>
                                    <div class="iq-card-header-toolbar d-flex align-items-center">
                                        <a href="categorie_bijoux.php" class="btn btn-sm btn-primary view-more">View
                                            More</a>
                                    </div>
                                </div>
                                <div class="iq-card-body favorites-contens">
                                    <ul id="favorites-slider" class="list-inline p-0 mb-0 row">
                                        ...
                                        $statement = $pdo->prepare($sql);
                                        $statement->execute(array('%Coliers%',));
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($result as $key=>$value) {  
                                        ?>
                                        <li class="col-md-3">
                        ...
                        <div class="col-lg-12">
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                <div
                                    ...
                                    <div class="iq-header-title">
                                        <h4 class="card-title mb-0">Bracelet</h4>
                                    </div>
                                    <div class="iq-card-header-toolbar d-flex align-items-center">
                                        <a href="categorie_bijourx.php" class="btn btn-sm btn-primary view-more">View
                                            More</a>
                                    </div>
                                </div>
                                <div class="iq-card-body similar-contens">
                                    <ul id="similar-slider" class="list-inline p-0 mb-0 row">
                                        ...
                                        $sql = "SELECT * FROM tbl_product WHERE ecat_id IN ( SELECT ecat_id FROM tbl_end_category INNER JOIN tbl_mid_category ON tbl_mid_category.mcat_id = tbl_end_category.mcat_id AND tbl_mid_category.mcat_name LIKE ? ) LIMIT 4";
                                        $statement = $pdo->prepare($sql);
                                        $statement->execute(array('%bracelet%',));
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                                        <li class="col-md-3">
                                            <?php
                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                ...
                                <div class="iq-card-body trendy-contens">
                                    <ul id="trendy-slider" class="list-inline p-0 mb-0 row">
                                        ...
                                        $sql = "SELECT * FROM tbl_product WHERE ecat_id IN ( SELECT ecat_id FROM tbl_end_category INNER JOIN tbl_mid_category ON tbl_mid_category.mcat_id = tbl_end_category.mcat_id AND tbl_mid_category.mcat_name LIKE ? ) LIMIT 20";
                                        $statement = $pdo->prepare($sql);
                                        $statement->execute(array('%electrinique%',));
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                                        <li class="col-md-3">
                                            <?php
