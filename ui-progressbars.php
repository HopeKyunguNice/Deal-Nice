...
<php lang="en">
                                ...
                                <div class="iq-card-body">
                                    <p>Progress components are built with two php elements, some CSS to set the width,
                                        ...
                                        a few attributes. We don’t use <a
                                            href="https://developer.mozilla.org/en-US/docs/Web/php/Element/progress">the
                                            php5 <code>&lt;progress&gt;</code> element</a>, ensuring you can stack
                                        progress
                                        bars, animate them, and place text labels over them.</p>
                                    <ul>
                                        <li>We use the <code>.progress</code> as a wrapper to indicate the max value of
                                            the
                                            progress bar.</li>
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <div class="progress" style="height: 20px;">
                                        <div class="progress-bar" role="progressbar" style="width: 99%;"
                                            aria-valuenow="99" aria-valuemin="0" aria-valuemax="100">99%</div>
                                    </div>
                                </div>
                            </div>
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <p>The striped gradient can also be animated. Add
                                        ...
                                        <code>.progress-bar</code> to animate the stripes right to left via CSS3
                                        animations.
                                    </p>
                                    <div class="progress mb-3">
    ...
    <!-- Mirrored from iqonic.design/themes/DealNice/php/ui-progressbars.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:47 GMT -->
