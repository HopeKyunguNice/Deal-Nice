                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <div class="form-group">
                                                            <label for="ccno" class="control-label">Contact Number:
                                                                *</label>
                                                            <input type="text" class="form-control" required="required"
                                                                id="ccno" name="ccno" placeholder="Contact Number">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <div class="form-group">
                                                            <label for="url" class="control-label">Company Url:
                                                                *</label>
                                                            <input type="text" class="form-control" required="required"
                                                                id="url" name="url" placeholder="Company Url.">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="cadd" class="control-label">Company Address:
                                                                *</label>
                                                            <textarea name="cadd" required="required" id="cadd"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label for="branch" class="control-label">Bank Branch Name:
                                                            *</label>
                                                        <input type="text" class="form-control" required="required"
                                                            id="branch" name="branch" placeholder="Bank Branch Name.">
                                                    </div>
                                                </div>
                                                <button class="btn btn-primary nextBtn btn-lg pull-right"
                                                    type="button">Next</button>
...
<!-- Mirrored from iqonic.design/themes/booksto/html/form-wizard-validate.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:49 GMT -->
