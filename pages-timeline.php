...
<php lang="en">
                        ...
                        <ul id="iq-sidebar-toggle" class="iq-menu">
                            <li>
                                ...
                                <ul id="dashboard" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li><a href="index.php"><i class="las la-house-damage"></i>Home Page</a></li>
                                    ...
                                    <li><a href="book-pdf.php"><i class="ri-file-pdf-line"></i>Book PDF</a></li>
                                    <li><a href="Checkout.php"><i
                                                class="ri-checkbox-multiple-blank-line"></i>Checkout</a>
                                    </li>
                            ...
                            <li>
                                <a href="#admin" class="iq-waves-effect" data-toggle="collapse"
                                    aria-expanded="false"><span class="ripple rippleEffect"></span><i
                                        class="ri-admin-line"></i><span>Admin</span><i
                                        class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                                <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li><a href="admin-dashboard.php"><i class="ri-dashboard-line"></i>Dashboard</a>
                                    </li>
                                    <li><a href="admin-category.php"><i class="ri-list-check-2"></i>Category Lists</a>
                                    </li>
                                    <li><a href="admin-author.php"><i class="ri-file-user-line"></i>Author</a></li>
                                ...
                                <ul id="ui-elements" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li class="elements">
                                        ...
                                        <ul id="sub-menu" class="iq-submenu collapse" data-parent="#ui-elements">
                                            ...
                                            <li><a href="ui-typography.php"><i
                                                        class="las la-keyboard"></i>Typography</a>
                                            </li>
                                            ...
                                            <li><a href="ui-notifications.php"><i
                                                        class="las la-bell"></i>Notifications</a>
                                            </li>
                                            <li><a href="ui-pagination.php"><i
                                                        class="las la-ellipsis-h"></i>Pagination</a>
                                            </li>
                                    ...
                                    <li>
                                        ...
                                        <ul id="icons" class="iq-submenu collapse" data-parent="#ui-elements">
                                            ...
                                            <li><a href="icon-lineawesome.php"><i class="ri-keynote-line"></i>line
                                                    Awesome</a></li>
                                            <li><a href="icon-remixicon.php"><i
                            ...
                            <li class="active active-menu">
                                ...
                                <ul id="pages" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                                    <li>
                                        <a href="#authentication" class="iq-waves-effect collapsed"
                                        ...
                                        <ul id="authentication" class="iq-submenu collapse" data-parent="#pages">
                                            ...
                                            <li><a href="sign-up.php"><i class="ri-login-circle-line"></i>Register</a>
                                            </li>
                                            <li><a href="pages-recoverpw.php"><i class="ri-record-mail-line"></i>Recover
                                                    Password</a></li>
                                            <li><a href="pages-confirm-mail.php"><i
                                                        class="ri-file-code-line"></i>Confirm
                                                    Mail</a></li>
                                            <li><a href="pages-lock-screen.php"><i class="ri-lock-line"></i>Lock
                                                    Screen</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="active active-menu">
                                        <a href="#extra-pages" class="iq-waves-effect collapsed" data-toggle="collapse"
                                            aria-expanded="true"><i class="ri-pantone-line"></i><span>Extra
                                        ...
                                        <ul id="extra-pages" class="iq-submenu collapse show" data-parent="#pages">
                                            <li class="active"><a href="pages-timeline.php"><i
                                                        class="ri-map-pin-time-line"></i>Timeline</a></li>
                                            <li><a href="pages-invoice.php"><i
                                                        class="ri-question-answer-line"></i>Invoice</a></li>
                                            <li><a href="blank-page.php"><i class="ri-invision-line"></i>Blank Page</a>
                                            </li>
                                            <li><a href="pages-error.php"><i class="ri-error-warning-line"></i>Error
                                                    404</a></li>
                                            <li><a href="pages-error-500.php"><i class="ri-error-warning-line"></i>Error
                                                    500</a></li>
                                            <li><a href="pages-pricing.php"><i class="ri-price-tag-line"></i>Pricing</a>
                                            </li>
                                            <li><a href="pages-maintenance.php"><i
                                                        class="ri-archive-line"></i>Maintenance</a></li>
                            ...
                            <li>
                                ...
                                <ul id="menu-level" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li class="menu-level">
                                                <a href="#sub-menus" class="iq-waves-effect collapsed"
                                                    data-toggle="collapse" aria-expanded="false"><i
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                        <div class="iq-menu-bt d-flex align-items-center">
                            ...
                            <div class="iq-navbar-logo d-flex justify-content-between">
                                <a href="index.php" class="header-logo">
                                    <img src="./assets/images/<?php echo $logo; ?>" class="img-fluid rounded-normal"
                                        alt="">
                                    <div class="logo-title">
                                        <span class="text-primary text-uppercase">DealNice</span>
                                    </div>
    ...
    <!-- Mirrored from iqonic.design/themes/DealNice/php/pages-timeline.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:54 GMT -->
